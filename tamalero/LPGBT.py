...
#        return wrapper
    ...
    def read_adc(self, channel, calibrate=True, convert=False):
        ...
        ------------------ |----------------------------------------
        4'd0               |  lpGBT1 ADC0 (external pin)
        4'd1               |  lpGBT1 ADC1 (external pin)
        4'd2               |  lpGBT1 ADC2 (external pin)
        4'd3               |  lpGBT1 ADC3 (external pin)
        4'd4               |  lpGBT1 ADC4 (external pin)
        4'd5               |  lpGBT1 ADC5 (external pin)
        4'd6               |  lpGBT1 ADC6 (external pin)
        4'd7               |  lpGBT1 ADC7 (external pin)
        4'd8               |  lpGBT2 ADC0 EOM DAC (internal signal)
        4'd9               |  lpGBT2 ADC1 VDDIO * 0.42 (internal signal)
        4'd10              |  lpGBT2 ADC2 VDDTX * 0.42 (internal signal)
        4'd11              |  lpGBT2 ADC3 VDDRX * 0.42 (internal signal)
        4'd12              |  lpGBT2 ADC4 VDD * 0.42 (internal signal)
        4'd13              |  lpGBT2 ADC5 VDDA * 0.42 (internal signal)
        4'd14              |  lpGBT2 ADC6 Temperature sensor (internal signal)
        4'd15              |  lpGBT2 ADC7 VREF/2 (internal signal)
        """
