...
class ETROC():
    ...
    def auto_threshold_scan(self, row=0, col=0, broadcast=False, offset='auto', time_out=1, verbose=False, use=True, repeat_count=0):
        '''
        From the manual:
        1. set "Bypass" low.
        ...
        if not broadcast:
            ...
            for i in range(15):
                for j in range(15):
                    if baseline[i][j] == 0:
                        print(f"Repeating threshold scan for ({row},{col}), baseline was 0")
